...
import { Users, Building2, CalendarDays, IndianRupee, Ticket, ArrowRight, ShieldCheck, Tag } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-extrabold text-white">Administrative Actions</h2>
          ...
          {quickActions.map((item) => {
            ...
            return (
              <div
                ...
                className="group relative cursor-pointer overflow-hidden rounded-3xl border border-white/10 bg-[#12121A]/80 p-6 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40 hover:shadow-2xl"
              >
                <div
                ...
                <h3 className="mt-5 text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
                  {item.label}
                </h3>
